		    ...
		    <div class="section-card" style="padding: 36px 0px;background-color: white">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Asisten Dosen. Website ini dibuat dengan bahasa PHP. Dan sistem ini dibuat untuk memenuhi nilai UTS mata kuliah Sistem Pendukung Keputusan </p>
						</div>
			    	<div class="col s6">
