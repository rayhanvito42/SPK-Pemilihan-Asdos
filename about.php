...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="home.php mr-5">Pemilihan Asisten Dosen SPK</a>
...
<div style="background-color:#434343;">
    <div class="container " >
		...
		<center> Rayhan Vito Gustiansyah <br></center>
		<center> Muhammad Auliya'ur Rahman <br></center>
		<center> Bagas Dwi Sulistyo <br></center>
	  </p> <br>
	  <center> <p>yang telah bekerjasama atas jalannya sistem ini</p></center>
    				<br>
				<center> <h5>kami</h5></center>
				<center> 1. Rayhan Vito Gustiansyah (20051397042)<br></center>
        <center> 2. Muhammad Auliya'ur Rahman (20051397066)<br></center>
				<center> 3. Bagas Dwi Sulistyo (20051397076) </p></center>
    </div>
                </div>
            </div>
        </div>
